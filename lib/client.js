		...
		function GitAction({ sessionId, useSessions, useWorkspaces, status, init, connectRemote, commit, push }) {
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("button", {
					ref: triggerRef,
					type: "button",
					className: (0, clsx.default)(GitAction_module_css_default.trigger, snapshot?.initialized === false && GitAction_module_css_default.triggerSetup, repository?.clean && GitAction_module_css_default.triggerClean, statusError !== void 0 && GitAction_module_css_default.triggerError),
					"aria-expanded": open,
